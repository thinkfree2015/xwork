...
<div class="am-u-md-12" style="margin-top: 4%;">
    <div class="am-btn-toolbar" style="float: right;">
        <div class="am-btn-group am-btn-group-xs" >
            <a href="<c:url value="/basic/xm.do?qm=formProject" /> " class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新建项目</a>
...
<ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list  " style="margin-top: 7%;">
    <c:forEach items="${requestScope.pageInfo.list}" var="projectUser">
        ...
        <li style="padding-bottom: 5%">
            ...
            <a href="<c:url value="/project/view.do?id=${projectUser.project.id}"/> " class="am-text-success"><img src="<c:url value="/scripts/image/project2.png"/>"/><br/><br/>${projectUser.project.title}<br/></a>
