...
<header class="am-topbar admin-header">
    ...
    <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
        ...
        <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
            ...
            %>
            <li class="am-hide-sm-only"><a href="<c:url value='/basic/xm.do?qm=plistTaskActivityInstanceExecution_default'/>" id="message-number"><i
                    class="fa fa-envelope"></i>   <span class="admin-fullText"> 0</span></a></li>
