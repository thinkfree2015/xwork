                ...
                if (data && data.length > 0) {
                    for (var i in data) {
                        ...
                        sub += "<article class=\"am-comment\">" +
                                ...
                                "            <a href=\"<c:url value='/basic/xm.do?qm=formTaskDynamic&id='/>" + data[i].creator.id + "\" class=\"am-comment-author\">" + data[i].creator.name +
                                "           </a>" + data[i].message + ": <a href=\"<c:url value='/basic/xm.do?qm=formTask&id='/>"+data[i].taskId+"&projectId="+data[i].projectId+"\" class=\"am-comment-author\" id=\""+data[i].taskId+"\">" + data[i].taskTitle +"</a>"+
                                "        </div>" +
                                "     </div>" +
                                "</article>";
                    }
